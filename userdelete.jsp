...
<script language="javascript">
    ...
    function chk1(){
        if(userdelete.pass.value==""){
            alert("비밀번호를 입력해주세요.");
            return false;
         }
         if(check_pass!=userdelete.pass.value){  
            alert("비밀번호가 다릅니다.");
        //비어있을 때 실행
        return false;
         }
        if (userdelete.reason.value == ""){
        alert("이유를 적어주세요.");
        //비어있을 때 실행
        return false;
       }
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
         <div class="row">
            ...
            <form name="userdelete" method="post" action="userdeletejsp.jsp"> 
        </div>
            ...
            <div class="form-group">
                탈&nbsp;&nbsp;퇴&nbsp;&nbsp;&nbsp;&nbsp;이&nbsp;&nbsp;유 &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp; <input type="text" name="reason" size="50px" style="height:200px;"  placeholder="  -이유">
            </div>
      </div>
      <div class="modal-footer">
          <div class="row">
              <input type="button" class="btn btn-primary btn-rg" value="회원탈퇴" onclick="chk1()">
   </form>  
