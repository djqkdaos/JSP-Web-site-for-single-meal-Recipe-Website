...
%>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">팀원 소개
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.jsp">Home</a>
                    </li>
                    <li class="active">팀원 소개</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-md-3">
                <!--a href="portfolio-item.html"-->
                    <img class="img-responsive" src="image/nam.jpg" alt="">
                </a>
            </div>
            <div class="col-md-5">
                <h3>김남억</h3>
        ...
        <!-- Project Five -->
         <div class="row">
            <div class="col-md-3">
                <!--a href="portfolio-item.html"-->
                    <img class="img-responsive" src="image/sin.jpg" alt="">
                </a>
            </div>
            <div class="col-md-5">
                <h3>신승우</h3>
                <h4>팀원</h4>
                <p>주 업무 : 자료수집 및 PPT제작</p>
