    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="fill" style="background-image:url('image/image1.jpg');"></div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('image/image2.jpg');"></div>
                <div class="carousel-caption">
                    <h2>볶음밥 먹고 싶다. <br>중식스타일로 계란 스크램블 만든뒤에 파기름내서 굴소스 새우 넣고 크...국물은 짬뽕국물..</h2>
                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('image/image3.jpg');"></div>
                <div class="carousel-caption">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <a href="portfolio-item.jsp">
                    <img class="img-responsive img-portfolio img-hover" src="image/m.jpg" alt="">
                </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="portfolio-item.jsp">
            ...
            <div class="col-md-4 col-sm-6">
                <a href="portfolio-item.jsp">
                    <img class="img-responsive img-portfolio img-hover" src="image/image4 - copy.jpg" alt="">
                </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="portfolio-item.jsp">
                    <img class="img-responsive img-portfolio img-hover" src="image/image5 - copy.jpg" alt="">
                </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="portfolio-item.jsp">
                    <img class="img-responsive img-portfolio img-hover" src="image/image6 - copy.jpg" alt="">
                </a>
            </div>
            ...
            <div class="col-md-4 col-sm-6">
                <a href="portfolio-item.jsp">
                    <img class="img-responsive img-portfolio img-hover" src="image/15.jpg" alt="" style="height: 240px; width: 400px">
                </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="portfolio-item.jsp">
                    <img class="img-responsive img-portfolio img-hover" src="image/14.jpg" alt="">
                </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="portfolio-item.jsp">
                    <img class="img-responsive img-portfolio img-hover" src="image/13.jpg" alt="">
                </a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <h3>가격 : 5,000원</h3>
                <br>
                <h5>떡볶이 떡, 어묵 3장, 양파 1/2개, 청양고추 1개,
                집고추장 2큰술, 고추가루 1큰술, 다진마늘 1큰술, 맛술 2큰술, 
                설탕 1큰술, 멸치액젓 1/2큰술, 물500ml</h5>
            </div>
            <div class="col-md-6">
