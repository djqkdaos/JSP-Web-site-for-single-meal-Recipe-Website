...
%>
   ...
   <!-- Navigation -->
    ...
    <!-- Page Content -->
        ...
        <div class="panel-heading" style="text-align: center;"><h2>게시물 수정</h2></div> 
        <div class="panel-body">
            <div class="container">
                <form action="modifly.jsp?idx=<%=idx%>" method="post" name=modiflyform>
                    <form role="form">
                    <!-- 이름 입력 폼 -->
                        <div class="row"> 
                                ...
                                <div class="form-group"> 
                                    <table>
                                        <th>    
                                            ...
                                            <th ><input type="text" class="form-control" name="name" id="name" placeholder="Enter name" value="<%=name%>" readonly></th> 
                        ...
                        <!-- //글제목 입력 폼 -->
                            <div class="form-group"> 
                                <label for="subject"><h4><strong>제목:</strong></h4></label> 
                                <input type="text" class="form-control" name ="title" id="title" placeholder="Enter title" value=<%=title%>> 
                            </div> 

                        <!-- //글내용 입력 폼  -->
                        <div class="form-group"> 
                        <label for="content"><h4><strong>내용:</strong></h4></label> 
                        ...
                        " onclick="modifyCheck();"> <input type="reset" class="btn btn-primary" value="취소" onclick="javascript:history.back(-1)"> 
