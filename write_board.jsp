...
%>
 <%if(id==null){%>
    ...
    <!-- Page Content -->
        ...
        <div class="panel-heading" style="text-align: center;"><h2>게시물 등록</h2></div> 
        <div class="panel-body">
            <div class="container">
                <form action="insert.jsp" method="post" name=modiflyform>
                    <form role="form">
                    <!-- 이름 입력 폼 -->
                        <div class="row"> 
                        ...
                        <div class="form-group"> 
                                    <table>
                                        <th>    
                                            ...
                                            <th ><input type="text" class="form-control" readonly name="name" value="<%=id%>" placeholder="Enter name"></th> 
                                            <th class = "col-md-2"><label for="pass" >비밀번호:</label></th> 
                                            <th class = "col-md-1"><input type="password" readonly class="form-control" name="pass" value="<%=pass%>" placeholder="Enter name"></th>
                                        </th> 
                                    </table>
                        </div> 
                        </div>
                        ...
                        <input type="button" class="btn btn-primary" value="저장하기" onclick="modifyCheck();"> <input type="reset" class="btn btn-primary" value="취소"onclick="javascript:history.back(-1)"> 
