...
<head>
    ...
    <script language="javascript">
        ...
        function check(){
           if (se.search.value==""||null){
            alert("찾는 품명을 입력 해 주세요.");
            return false;
           }
           se.submit();
        }
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <div align="right">
                    <form method="post" name="se" action="searchresult.jsp">
                        <input type="text" name="search">
                        <input type="button" class="btn btn-primary" value="검색" onclick="check()">
                    </div>
                    </form>
                </ol>
            </div>
                ...
                <div class="row">
                              <%   
                                 while(rs.next()){
                                    ...
                                    String mingredients = rs.getString("mingredients");
                                    request.setAttribute("mname",mname);
                            %> <form method="post" name="menuinfo" action="menuupdate.jsp">
                                    <div class="col-md-4">
                                        <div class="panel panel-default text-center">
                                            <div class="panel-heading">
                                                <h3><input readonly="text" style = "text-align:center; border:none; background-color:transparent" value="<%=mname%>" name="tname"></h3>
                                            </div>
                                            <div class="panel-body" name="mimage" align="center">
                                                   <img class="img-responsive" src="<%=mimage%>" style="width: 200px; height: 200px; align-items: center" name="mimage">
                                                   <input readonly="text" style = "text-align:center; border:none; color:white" value="<%=mimage%>" name="mimage">
                                            </div>
                                            <ul class="list-group">
                                                <li class="list-group-item"> <input readonly="text" style = "text-align:center; border:none" value="<%=mprice%>" name="mprice"></li>
                                                  <li class="list-group-item"><input readonly="text" style = "text-align:center; border:none" value="<%=mingredients%>" name="mingredients"></li>
                                                      <input type="submit" class="btn btn-primary btn-rg" value="수정">
                                                        </form>
                                            </ul>
                                        </div>
                                    </div>
